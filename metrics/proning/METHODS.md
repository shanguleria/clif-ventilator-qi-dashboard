...
**Current headline (all units · all time):** ever proned = 350 / 1,854 = 18.9% (of PROSEVA-eligible; n_unit = patients)
...
> Position table at this site charts only proning episodes; only 350/1854 eligible have any position record, so ever-proned is a process floor. Median first prone session 16 h (IQR 7–23 h), among IMV-era proned. 71 were awake/pre-intubation proned (proned < T₀, mostly COVID-era), excluded from timing.
