...
**Definition version:** `sat-v1`

**Headline definition:** SAT performed — denominator: of eligible vent-sedation days (unit = patient-days). _Current per-site value: see the tile feed / `output_to_share/manifest.json`._

**Segments reported:** Resumed sedation, Not resumed (day), Extubated same day
